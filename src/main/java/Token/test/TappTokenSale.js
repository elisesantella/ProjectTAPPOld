var TappTokenSale = artifacts.require("./TappTokenSale.sol");
var TappToken = artifacts.require("./TappToken.sol");

contract('TappTokenSale', function(accounts) {
    var tokenSaleInstance;
    var tokenInstance;
    var admin = accounts[0];
    var buyer = accounts[1];
    var tokenPrice = 1000000000000000; //in wei - solidity
    var tokensAvaliable = 750000;
    var numberOfTokens;

    it('initalises the contract with the correct values', function() {
        return TappTokenSale.deployed().then(function(instance) {
    ...
    it('ends token sale', function() {
        return TappToken.deployed().then(function(instance) {
          ...
          // Check that the contract has no balance -BELOW NOT WORKING WHTY
